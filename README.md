...
It's current version is able to parse and pretty print the [Manchester Syntax](https://www.w3.org/TR/owl2-manchester-syntax)

**DISCLAIMER**: This a work in progress and by no means complete
