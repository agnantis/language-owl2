...
instance PrettyF Axiom where
  pretty (Axiom ans (DeclarationAxiom e))                           = "Declaration" <> parens (pretty ans <-> pretty e)
  pretty (Axiom ans (AnnotationAxiomDomain p i))                    = prettyAxiom "AnnotationPropertyDomain" (ans, p, i)
  pretty (Axiom ans (AnnotationAxiomRange p i))                     = prettyAxiom "AnnotationPropertyRange" (ans, p, i)
  pretty (Axiom ans (AnnotationAxiomSubProperty p1 p2))             = prettyAxiom "SubAnnotationPropertyOf" (ans, p1, p2)
  pretty (Axiom ans (AnnotationAxiomAssertion i (Annotation t v)))  = "AnnotationAssertion" <> parens (pretty ans <-> pretty t <+> pretty i <+> pretty v)
  pretty (Axiom ans (DatatypeAxiomDefinition d r))                  = prettyAxiom "DatatypeDefinition" (ans, d, r)
  pretty (Axiom ans (ObjectPropAxiomDomain o e))                    = prettyAxiom "ObjectPropertyDomain" (ans, o, e)
  pretty (Axiom ans (ObjectPropAxiomRange o e))                     = prettyAxiom "ObjectPropertyRange" (ans, o, e)
  pretty (Axiom ans (ObjectPropAxiomCharacteristics o c))           = pretty c <> "ObjectProperty" <> parens (pretty ans <-> pretty o)
  pretty (Axiom ans (ObjectPropAxiomSubProperty o1 o2))             = prettyAxiom "SubObjectPropertyOf" (ans, o1,  o2)
  pretty (Axiom ans (ObjectPropAxiomChainSubProperty c o))          = prettyAxiom "SubObjectPropertyOf" (ans, c, o)
  pretty (Axiom ans (ObjectPropAxiomEquivalent o os))               = prettyAxiom "EquivalentObjectProperties" (ans, o, os)
  pretty (Axiom ans (ObjectPropAxiomDisjoint  o os))                = prettyAxiom "DisjointObjectProperties" (ans, o, os)
  pretty (Axiom ans (ObjectPropAxiomInverse o1 o2))                 = prettyAxiom "InverseObjectProperties" (ans, o1, o2)
  pretty (Axiom ans (DataPropAxiomDomain d c))                      = prettyAxiom "DataPropertyDomain" (ans, d, c)
  pretty (Axiom ans (DataPropAxiomRange d r))                       = prettyAxiom "DataPropertyRange" (ans, d, r)
  pretty (Axiom ans (DataPropAxiomCharacteristics d c))             = pretty c <> "DataProperty" <> parens (pretty ans <-> pretty d)
  pretty (Axiom ans (DataPropAxiomSubProperty d1 d2))               = prettyAxiom "SubDataPropertyOf" (ans, d1, d2)
  pretty (Axiom ans (DataPropAxiomEquivalent d ds))                 = prettyAxiom "EquivalentDataProperties" (ans, d, ds)
  pretty (Axiom ans (DataPropAxiomDisjoint d ds))                   = prettyAxiom "DisjointDataPropertiesDataProperties" (ans, d, ds)
  pretty (Axiom ans (ClassAxiomSubClassOf e1 e2))                   = prettyAxiom "SubClassOf" (ans, e1, e2)
  pretty (Axiom ans (ClassAxiomEquivalentClasses e es))             = prettyAxiom "EquivalentClasses" (ans, e, es)
  pretty (Axiom ans (ClassAxiomDisjointClasses e es))               = prettyAxiom "DisjointClasses" (ans, e, es)
  pretty (Axiom ans (ClassAxiomDisjointUnion i es))                 = prettyAxiom "DisjointUnion" (ans, i, es)
  pretty (Axiom ans (ClassAxiomHasKey e od))                        = prettyAxiom "HasKey" (ans, e, od)
  pretty (Axiom ans (AssertionAxiomSameIndividuals i is))           = prettyAxiom "SameIndividual" (ans, i, is)
  pretty (Axiom ans (AssertionAxiomDifferentIndividuals i is))      = prettyAxiom "DifferentIndividuals" (ans, i, is)
  pretty (Axiom ans (AssertionAxiomClass i e))                      = prettyAxiom "ClassAssertion" (ans, i, e)
  pretty (Axiom ans (AssertionAxiomObjectProperty o i1 i2))         = prettyAxiom "ObjectPropertyAssertion" (ans, o, atLeast2List i1 i2 [])
  pretty (Axiom ans (AssertionAxiomNegativeObjectProperty o i1 i2)) = prettyAxiom "NegativeObjectPropertyAssertion" (ans, o, atLeast2List i1 i2 [])
  pretty (Axiom ans (AssertionAxiomDataProperty d i l))             = "DataPropertyAssertion" <> parens (pretty ans <-> pretty d <+> pretty i <+> pretty l)
  pretty (Axiom ans (AssertionAxiomNegativeDataProperty d i l))     = "NegativeDataPropertyAssertion" <> parens (pretty ans <-> pretty d <+> pretty i <+> pretty l)
